...
class Item extends PureComponent {
  ...
  render () {
    const { attachment, lang, standalone, displayWidth, visible } = this.props;
...
class GalleryWorks extends PureComponent {
  ...
  isFullSizeEligible() {
    ...
    return media.getIn([0, 'meta', 'small', 'aspect']);
  }
...
export default injectIntl(GalleryWorks);
